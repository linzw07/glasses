<?php
class Gala_Bigshopsettings_Helper_Sample extends Mage_Core_Helper_Abstract
{
	protected $_themeSlug  = 'default/galabigshop';
	...
	protected $_megaMenuModel = 'bigshopsettings/megamenupro';
