<?php
class Gala_Bigshopsettings_Adminhtml_Bigshopsettings_ThemeController extends Mage_Adminhtml_Controller_Action
{
	protected $_prefixBlock = 'galabigshop_';
	protected $_prefixPage = 'galabigshop_';
	protected $_packageTheme = 'default/galabigshop';
