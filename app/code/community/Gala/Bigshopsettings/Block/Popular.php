...
class Gala_Bigshopsettings_Block_Popular extends Mage_Core_Block_Template
{
    protected $_tags;
        ...
        if (count($this->getTags()) > 0) {
            if($setting->getFlashtag_Enabled()){
                if($setting->checkMobile()=='false'){
                    $this->setTemplate('tag/galabigshop/popular.phtml');
                }
            }
    ...
    public function getFlashTag(){
        ...
        $path = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA).'galabigshop/tagcloud.swf';
        ...
        $html = '<embed id="flashtags_popular" width="280" height="280" flashvars="'.$flashVars.'" wmode="transparent" allowscriptaccess="always"
    ...
    public function isEnableFlashtag(){
        return Mage::getStoreConfig('bigshop/flashtag/enabled');
    }

    public function getWidth(){
        return Mage::getStoreConfig('bigshop/flashtag/width');
    }

    public function getHeight(){
        return Mage::getStoreConfig('bigshop/flashtag/height');
    }

    public function getCount(){
        return Mage::getStoreConfig('bigshop/flashtag/count');
    }

    public function getBackground(){
        return Mage::getStoreConfig('bigshop/flashtag/back');
    }

    public function getMaxSize(){
        return Mage::getStoreConfig('bigshop/flashtag/max');
    }

    public function getMinSize(){
        return Mage::getStoreConfig('bigshop/flashtag/min');
    }

    public function getMaxColor(){
        return Mage::getStoreConfig('bigshop/flashtag/maxcolor');
    }

    public function getNormalColor(){
        return Mage::getStoreConfig('bigshop/flashtag/normal');
    }

    public function getHoverColor(){
        return Mage::getStoreConfig('bigshop/flashtag/hover');
    }
    
    public function getSpeed(){
        return Mage::getStoreConfig('bigshop/flashtag/speed');
    }
}
